...
+ (NSString *)StringWithSuffix:(NSString *)suffix{
//    NSString * requestUrl = [NSString stringWithFormat:@"%@%@",PostUrl,suffix];
//    NSLog(@"当前请求的地址为-----%@",requestUrl);
    return [NSString stringWithFormat:@"%@%@",PostUrl,suffix];
}
