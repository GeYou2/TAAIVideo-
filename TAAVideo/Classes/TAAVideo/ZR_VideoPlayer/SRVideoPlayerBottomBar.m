...
static const CGFloat kItemWH = 40;
...
- (UIButton *)playPauseBtn {
    if (!_playPauseBtn) {
        ...
        [_playPauseBtn setImage:[UIImage imageNamed:@"暂停"] forState:UIControlStateNormal];//暂停图标
...
- (UIButton *)changeScreenBtn {
    if (!_changeScreenBtn) {
        ...
        [_changeScreenBtn setImage:[UIImage imageNamed:@"icon_enlarge"] forState:UIControlStateNormal];//全屏图标
